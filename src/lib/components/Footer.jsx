...
import { ReactComponent as PortfolioIcon } from '../assets/light-logo.svg';
import ProfileImage from '../assets/profile-transparent-square.png';
	...
	return (
		<footer className={cn.wrapper}>
			...
			<div className={cn.articles}>
				...
				<h3>Projects</h3>
				<a href='https://pickban.pro/' className={cn.article}>
					<h4>Pick Ban Pro</h4>
					<time dateTime='2021-5'>May 2021</time>
					<span>https://pickban.pro</span>
				</a>
				<a href='https://boba.watch/' className={cn.article}>
					<h4>Boba Watch</h4>
